...
public interface ClientManager {
    ...
    void updateClient(long clientId, String param, String value);
    void updateClient(Client client);

    void updateClientAddress(long clientId, String address);

    void updateClientEmail(long clientId, String email);
    void updateClientPhone(long clientId, String phone);

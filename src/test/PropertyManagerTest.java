...
public class PropertyManagerTest {
    ...
    public void testNewGetProp() throws Exception {
        Assert.assertEquals(0.015, pm.getProperty(AccountType.REGULAR, "deposit_commission"));
        Assert.assertEquals(1000000D, pm.getProperty(AccountType.GOLD, "deposit_credit"));
    }
}